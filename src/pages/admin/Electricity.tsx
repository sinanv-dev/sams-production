...
export const AdminElectricity: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'payments' | 'electricity'>('electricity');
    ...
    <div className="space-y-6 p-6 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">Change electricity unit price, log utility readings, manage pending utility bills, view graphs, and record payments.</p>
        </div>
