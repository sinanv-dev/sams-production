...
import { User, Mail, Phone, Lock, Save, CheckCircle, Moon, Sun, Monitor, Briefcase, MapPin } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div>
        ...
        <p className="text-muted-foreground text-sm font-medium mt-0.5">Manage your account, appearance, and notification preferences.</p>
      </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-9 pr-4 py-2.5 text-sm bg-table-header border border-border rounded-xl focus:outline-none focus:border-emerald-500 text-foreground" 
                    placeholder="e.g. SAMS Realty Group"
                  />
                </div>
              </div>
